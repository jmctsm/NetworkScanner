...
from scan_mods.common_validation_checks.check_password import (
    check_password,
)
...
class TestCheckPassword(unittest.TestCase):
    def test_01_all_pass(self):
        ...
        for test_tuple in test_list:
            ...
            self.assertEqual(check_password(password, address), expected)
    ...
    def test_03_test_input_logic_pass(self, getpw):
        ...
        self.assertEqual(check_password(None, "192.168.1.1"), "ciscocisco")
    ...
    def test_04_test_input_logic_return(self, getpw):
        ...
        for test_tuple in test_list:
            ...
            self.assertEqual(check_password(None, "192.168.1.1"), test_value)
