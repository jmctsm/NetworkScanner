...
class TestPortScanner(unittest.TestCase):
    ...
    def test_01_strip_alligators_all_pass(self):
        """
        This will test the strip alligators function and make sure that it passes
        """
        print(
            "\nStarting the test for the strip_alligators function passes correctly..."
        )
        strings_to_test = [
            "<first test>",
            "<<second test>>",
        ...
        while counter < len(strings_to_test):
            self.assertEqual(
                scan_mods.protocol_scanners.dns_scanner.strip_alligators(
                    strings_to_test[counter]
                ),
                good_values[counter],
            )
            counter += 1
        ...
        print(
            "Finished the test for the strip_alligators function passes correctly...\n"
        )

    def test_02_strip_alligators_raises_error(self):
        """
        This will test the strip alligators function and make sure that it raises an error
        """
        print(
            "\nStarting the test for the strip_alligators function raises an error..."
        )
        ...
        with self.assertRaises(TypeError):
            scan_mods.protocol_scanners.dns_scanner.strip_alligators(p=Fail_Class())

        print(
            "Finished the test for the strip_alligators function raises an error...\n"
        )

    def test_03_validate_server_domainname_function_all_pass(self):
        """
    ...
    def test_04_validate_failures(self):
        """
    ...
    def test_05_udp_dns_scanner_all_pass(self):
        """
    ...
    def test_06_tcp_dns_scanner_all_pass(self):
        """
